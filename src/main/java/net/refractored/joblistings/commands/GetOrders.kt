...
class GetOrders {
    ...
    fun getOrders(actor: BukkitCommandActor, @Optional page: Int = 1) {
        ...
        Order.getOrdersPage(21,0).forEachIndexed { index, order ->
        ...
        gui.setToolbarBuilder{ i, i2, sgToolbarButtonType, sgMenu ->
             spiGUI.defaultToolbarBuilder.buildToolbarButton(i, i2, sgToolbarButtonType, sgMenu)
        }
